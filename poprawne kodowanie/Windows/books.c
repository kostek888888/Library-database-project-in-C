...
/*!
 *   @brief funkcja uzupeˆnia dane w konkretnym elemencie listy ksi¥¾ek utworzonym przez funkcj© add_new_client
 *
...
/*!
 *   @brief funkcja tworzy element listy ksi¥¾ek a nast©pnie wywoˆuje funkcj© new_book_fill kt¢ra uzupeˆnia pola danych elementu
 *
...
/*!
 *   @brief funkcja usuwa caˆ¥ baz© ksi¥¾ek
 *
 *   @param Library **base_pointer podw¢jny wska«nik na list© ksi¥¾ek
 */
...
void search_for_book(Library *base_pointer)
{
    ...
    switch(choice){
        case 1:
                ...
                break;
        case 2:
                printf("\n Wpisz tytuˆ ksi¥¾ki jak¥ chcesz znale«†: ");
                gets(title);
        ...
        case 4:
                ...
                break;
        default:
                printf("\n Dokonano nieprawidˆowego wyboru w funkcji szukaj¥cej");
    }
}


/*!
 *   @brief funkcja usuwa pojedyäcz¥ ksi¥¾k© z bazy ksi¥¾ek
 *
 *   @param Library **base_pointer podw¢jny wska«nik na list© ksi¥¾ek
 */
...
/*!
 *   @brief funkcja wypisuje na ekran caˆ¥ list© ksi¥¾ek
 *
 *   @param Library *base_pointer wska«nik na list© ksi¥¾ek
 */
...
/*!
 *   @brief funkcja zapisuje caˆ¥ list© ksi¥¾ek do pliku books.txt
 *
 *   @param Library *base_pointer wska«nik na list© ksi¥¾ek
 */
...
/*!
 *   @brief funkcja pozwala na edycj© pojedyäczej ksi¥¾ki, nale¾y poda† jej id
 *
 *   @param Library *base_pointer wska«nik na list© ksi¥¾ek
 */
...
/*!
 *   @brief funkcja sortuje ksi¥¾ki na li˜cie wedˆug wskazanego przez u¾ytkownika wyboru a nast©pnie wywoˆuje wypisanie listy ksi¥¾ek na ekran
 *
