...
int count_borrow_list=0; /*!< zmienna licz¥ca ilo˜† element¢w listy wypo¾yczeä */


/*!
 *   @brief funkcja uzupeˆnia dane w konkretnym elemencie listy wypo¾yczeä utworzonym przez funkcj© add_new_borrow
 *
 *   @param Borrow *(*new_borrow_node) podw¢jny wska«nik na nowy element listy wypo¾yczeä
...
/*!
 *   @brief funkcja tworzy element listy wypo¾yczeä a nast©pnie wywoˆuje funkcj© new_borrow_fill kt¢ra uzupeˆnia pola danych elementu
 *
...
/*!
 *   @brief funkcja usuwa caˆ¥ baz© wypo¾yczeä, aby zachowa† histori© ci¥gle w programie nie jest ona kasowalna przez uzytkownika mo¾na j¥ skasowa† tylko wyˆ¥czaj¥c program
 *
...
/*!
 *   @brief funkcja pozwala klientowi odda† ksia¾k©, musi on poda† sw¢j id i id wypo¾yczonej ksi¥¾ki. Oddanie jest sygnalizowane przez dopisanie sˆowa oddane w danej char give_back[6]
 *
 *   @param Library *base_pointer wska«nik na list© wypo¾yczeä
 */
...
/*!
 *   @brief funkcja wypisuje na ekran caˆ¥ list© wypo¾yczeä
 *
 *   @param Borrow *borrow_base_pointer wska«nik na list© wypo¾yczeä
 */
...
/*!
 *   @brief funkcja zapisuje caˆ¥ list© wypo¾yczeä do pliku borrow.txt
 *
 *   @param Borrow *borrow_base_pointer wska«nik na list© wypo¾yczeä
 */
