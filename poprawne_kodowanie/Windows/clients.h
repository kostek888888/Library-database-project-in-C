...
/*!
 *   @brief Struktura zawieraj¥ca pola listy klient¢w, z kt¢rej bedzie tworzona baza klient¢w
 *
 *   @param Client::client_id id klienta
 *   @param Client::name[100] imi© klienta
 *   @param Client::char surname[100] nazwisko klienta
 *   @param Client::int d_of_b_day dzieä urodzenia klienta
